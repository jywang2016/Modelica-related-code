...
model HeatingLoop_v3a
  // v3a:
  // Same to v3, just adding parameters to set the boiler setpoints
  // In * v3 *
  ...
  parameter Real boiler_high_T = 273.15+80 "boiler high temperature off limit";
  parameter Real boiler_low_T = 273.15+60 "boiler low temperature on limit";
  ...
  Modelica.Blocks.Sources.Constant constBoilerTempHighLimit(k = boiler_high_T)  annotation(
  ...
  Modelica.Blocks.Sources.Constant constBoilerTempLowLimit(k = boiler_low_T)  annotation(
