...
model CoolingLoop_v2
    ...
    Placement(visible = true, transformation(origin = {4, -48}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-6, -82}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  //initial equation
