...
model HVACv4a_WL_Fault2
  ...
  Modelica.Blocks.Nonlinear.Limiter limiter1(uMax = 0.8, uMin = 0.6)  annotation(
    Placement(visible = true, transformation(origin = {-20, -18}, extent = {{-6, -6}, {6, 6}}, rotation = 0)));
equation
  connect(limiter1.y, swValHeating.u) annotation(
    Line(points = {{-14, -18}, {-6, -18}, {-6, 42}, {12, 42}, {12, 56}, {12, 56}}, color = {0, 0, 127}));
  connect(controlUnit.yHeating, limiter1.u) annotation(
    Line(points = {{-44, 10}, {-34, 10}, {-34, -18}, {-28, -18}, {-28, -18}}, color = {0, 0, 127}));
