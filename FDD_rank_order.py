'''
A revised version of test6_rank_order_classified_heatload_FDD+PAA.py
...
# output paths:
fig_loc = r'N:\HVAC_ModelicaModel_Data\python_figs\rank_Boston+SmallOffice_Workday'
result_loc = r'N:\HVAC_ModelicaModel_Data\python_figs\rank_Boston+SmallOffice_Workday'
...
for rank_method_index in range(len(rank_methods)):
    for testdata_name in testdata_names:
        ...
        predArr_lof,predArr_iForest =   anomaly_detection(testdata_name,rank_method_index,
                                                          test_EVs_ts,test_MVs_ts,fig_loc,result_loc)
