...
model HVACv4a_WL_Fault1_OAD
  // v4a_WL_Fault1_OAD:
  // Same as v4a_WL_Fault1, except limiting OAD instead of SAD
  // v4a_WL_Fault1:
  ...
  Modelica.Blocks.Nonlinear.Limiter limiter1(uMax = 0.5, uMin = 0.4)  annotation(
    Placement(visible = true, transformation(origin = {-36, 80}, extent = {{-4, -4}, {4, 4}}, rotation = -90)));
equation
  connect(controlUnit.ySAD, ahu1.y_SA) annotation(
    Line(points = {{-44, 22}, {-8, 22}, {-8, 78}, {-24, 78}, {-24, 68}, {-24, 68}, {-24, 66}}, color = {0, 0, 127}));
  connect(limiter1.y, ahu1.y_OA) annotation(
    Line(points = {{-36, 76}, {-36, 76}, {-36, 66}, {-36, 66}}, color = {0, 0, 127}));
  connect(controlUnit.yOAD, limiter1.u) annotation(
    Line(points = {{-44, 24}, {-44, 24}, {-44, 88}, {-36, 88}, {-36, 84}, {-36, 84}}, color = {0, 0, 127}));
