...
model HVACv3a_WL_Fault5
  // v3a_WL_Fault5:
  // Identical to v3a_weather_load except replacing the cooling loop with CoolingLoop_v4F5.
  // CoolingLoop_v4F5 is same to CoolingLoop_v4 but with a different setting (lower QEva_flow_nominal and etaCarnot_nominal),
  // this is for simulating a lowered efficiency due to refrigerant leak
  // v3a_weather_load:
  ...
  TestSys.CoolingLoop_v4F5 coolingLoop_v4 annotation(
