...
testdata_names = ['102_HVACv4a_Weather+HeatLoadDataTest_Boston+SmallOffice',
                  '103_HVACv4a_Weather+HeatLoadDataTest_Boston+SmallOffice_Fault1',
                  '104_HVACv4a_Weather+HeatLoadDataTest_Boston+SmallOffice_Fault2',
                  '105_HVACv4a_Weather+HeatLoadDataTest_Boston+SmallOffice_Fault3',
                  '111_HVACv4a_Weather+HeatLoadDataTest_Boston+SmallOffice_Fault5',
                  '112_HVACv4a_Weather+HeatLoadDataTest_Boston+SmallOffice_Fault6',
                  '110_HVACv4a_Weather+HeatLoadDataTest_Boston+SmallOffice_random'
                 ]
...
for rank_method_index in range(len(rank_methods)):
    for testdata_name in testdata_names:
        test_EVs_ts,test_MVs_ts = load_test_data(testdata_name)
