...
model AHUwithCooling_v3
  ...
  Modelica.Blocks.Sources.Sine sine1(amplitude = 0.5, freqHz = 0.005, offset = 0.5)  annotation(
    Placement(visible = true, transformation(origin = {15, 25}, extent = {{-5, -5}, {5, 5}}, rotation = 0)));
equation
  connect(sine1.y, coolingLoop_v4.yCooling) annotation(
    Line(points = {{20, 26}, {28, 26}, {28, 24}, {28, 24}}, color = {0, 0, 127}));
  ...
  connect(coolingLoop_v4.port_b, hexCoolingCoil.port_a2) annotation(
    Line(points = {{50, 38}, {50, 38}, {50, 48}, {50, 48}}, color = {0, 127, 255}));
