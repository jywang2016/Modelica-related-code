...
model HVACv3a_WL_Fault1
  ...
  Modelica.Blocks.Nonlinear.Limiter limiter1(uMax = 0.6, uMin = 0.3)  annotation(
    Placement(visible = true, transformation(origin = {-14, 80}, extent = {{6, -6}, {-6, 6}}, rotation = 0)));
equation
  connect(limiter1.y, ahu1.y_SA) annotation(
    Line(points = {{-20, 80}, {-24, 80}, {-24, 66}, {-24, 66}}, color = {0, 0, 127}));
  connect(controlUnit.ySAD, limiter1.u) annotation(
    Line(points = {{-44, 22}, {-6, 22}, {-6, 80}, {-6, 80}}, color = {0, 0, 127}));
