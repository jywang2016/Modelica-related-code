...
model AHUwithCooling_v2
  ...
  Modelica.Blocks.Sources.Constant OutsideTemp(k = 308.15) annotation(
  ...
  Modelica.Blocks.Sources.BooleanPulse booleanPulse1(period = 300)  annotation(
    Placement(visible = true, transformation(origin = {15, 21}, extent = {{-5, -5}, {5, 5}}, rotation = 0)));
equation
  connect(booleanPulse1.y, coolingLoop_v3.yOnOff) annotation(
    Line(points = {{20, 22}, {28, 22}, {28, 22}, {28, 22}}, color = {255, 0, 255}));
  connect(senToutside.T, coolingLoop_v3.T_ambient) annotation(
    Line(points = {{-54, 64}, {-54, 64}, {-54, 82}, {28, 82}, {28, 34}, {28, 34}}, color = {0, 0, 127}));
  connect(coolingLoop_v3.port_a, hexCoolingCoil.port_b2) annotation(
    Line(points = {{32, 36}, {32, 36}, {32, 48}, {32, 48}}, color = {0, 127, 255}));
  connect(coolingLoop_v3.port_b, hexCoolingCoil.port_a2) annotation(
