...
model CoolingLoop_v4F5
  ...
  // v4F5: same as v4 but changed parameters to simulate fault 5:
  ...
  Buildings.Fluid.Chillers.Carnot_TEva chiller(redeclare package Medium1 = water, redeclare package Medium2 = water, QEva_flow_nominal = -3e5, dp1_nominal = 100, dp2_nominal = 100, energyDynamics = Modelica.Fluid.Types.Dynamics.DynamicFreeInitial, etaCarnot_nominal = 0.2) annotation(
