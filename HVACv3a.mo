...
model HVACv3a
  ...
  TestSys.ControlUnitType2 controlUnit( kd = 0.01,ki = 0.01, kp = 0.01, maxPower = 0.2, minPower = 0.02, setSAT = false)  annotation(
...
equation
  connect(sine1.y, Outside.T_in) annotation(
    Line(points = {{-68, 90}, {-74, 90}, {-74, 80}}, color = {0, 0, 127}));
