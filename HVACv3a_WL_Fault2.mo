...
model HVACv3a_WL_Fault2
  // v3a_WL_Fault2:
  // Add in fault2: Stuck/clogged swValHeating simulated by limiting the yHeating signal
  // v3a_weather_load:
  ...
  Modelica.Blocks.Nonlinear.Limiter limiter1(uMax = 1, uMin = 0.5)  annotation(
    Placement(visible = true, transformation(origin = {-18, -18}, extent = {{-6, -6}, {6, 6}}, rotation = 0)));
equation
  connect(limiter1.y, swValHeating.u) annotation(
    Line(points = {{-12, -18}, {-6, -18}, {-6, 42}, {12, 42}, {12, 56}, {12, 56}}, color = {0, 0, 127}));
  connect(controlUnit.yHeating, limiter1.u) annotation(
    Line(points = {{-44, 10}, {-30, 10}, {-30, -18}, {-26, -18}, {-26, -18}}, color = {0, 0, 127}));
